export function generateReport(commonData: any) {
  const {
...
<body>
  <div class="page">
    ...
    <div class="title">BRSR Core emissions<br />Compliance Report</div>
    ...
    <div class="toc">
      ...
      <div class="toc-row"><span>2. BRSR Core Metrics</span><span>Page 3</span></div>
